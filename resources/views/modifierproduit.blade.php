...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('produits.update', $produit->id) }}" method="POST">
            @csrf
            @method('PUT') <!-- Utilisé pour la requête PUT -->
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="prix" name="prix" step="0.01" value="{{ old('prix', $produit->prix) }}" required>
            </div>

            <div class="mb-3">
                <label for="quantite" class="form-label">Quantité</label>
                <input type="number" class="form-control" id="quantite" name="quantite" value="{{ old('quantite', $produit->quantite) }}" required>
            </div>
            ...
            <a href="{{ route('gestionproduits') }}" class="btn btn-secondary">Annuler</a>
        </form>
    </div>
