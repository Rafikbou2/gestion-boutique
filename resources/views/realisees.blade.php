...
<body>
    ...
    <ul class="pagination">
        ...
        <li class="page-item {{ $page == 1 ? 'disabled' : '' }}">
            <a class="page-link" href="{{ route('ventes.realisees', ['page' => $page - 1]) }}" aria-label="Previous">
        ...
        @for ($i = 1; $i <= $totalPages; $i++)
            <li class="page-item {{ $i == $page ? 'active' : '' }}">
                <a class="page-link" href="{{ route('ventes.realisees', ['page' => $i]) }}">{{ $i }}</a>
            </li>
        @endfor

        <!-- Lien vers la page suivante -->
        <li class="page-item {{ $page == $totalPages ? 'disabled' : '' }}">
            <a class="page-link" href="{{ route('ventes.realisees', ['page' => $page + 1]) }}" aria-label="Next">
